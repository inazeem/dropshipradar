<nav x-data="{ open: false }" class="relative z-50 border-b border-white/10 bg-slate-900/60 backdrop-blur-xl">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <span class="font-display text-lg tracking-wide text-cyan-200">Dropship Radar</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link class="text-slate-200 border-rose-400" :href="route('admin.import.create')" :active="request()->routeIs('admin.import.*')">
                        Import
                    </x-nav-link>
                    @endif
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-white/15 text-sm leading-4 font-medium rounded-md text-slate-100 bg-slate-800/70 hover:text-cyan-200 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.import.create')" :active="request()->routeIs('admin.import.*')">
                Import
            </x-responsive-nav-link>
            @endif
        </div>
